...
const final2014 = fifaData.filter(data => (data.Year === 2014 && data.Stage === "Final"));
console.log("task 1", final2014);
...
function getWinners(array,cb) {
    ...
    cb(array).forEach(function(item){
        ...
        else {return winners.push(item["Away Team Name"]);     
        }
    });      
return winners;
}
...
function getWinnersByYear(array, cb3, cb4) {
    /* code here */
}
